...
const HomeLanding = () => {
  ...
  return (
    <div className="container-xxl bg-white p-0 ">
      ...
      {/* <!-- Navbar & Hero Start --> */}
      <div className="container-xxl position-relative p-0 mt-100">
            ...
            <div className="row g-4">
              ...
              <div className="col-lg-6">
                <div className="testimonial-item bg-transparent border rounded p-4 h-100">
                  ...
                  <p>This is the first client's feedback. You can update this to your actual client review later.</p>
              ...
              <div className="col-lg-6">
                <div className="testimonial-item bg-transparent border rounded p-4 h-100">
                  <i className="fa fa-quote-left fa-2x text-primary mb-3"></i>
                  <p>This is the second client's feedback. Add any custom message here.</p>
                  <div className="d-flex align-items-center mt-4">
                    <img
                      className="img-fluid flex-shrink-0 rounded-circle"
              ...
              <div className="col-lg-6">
                <div className="testimonial-item bg-transparent border rounded p-4 h-100">
                  <i className="fa fa-quote-left fa-2x text-primary mb-3"></i>
                  <p>This third testimonial is a placeholder. Replace it with your client's actual review.</p>
                  <div className="d-flex align-items-center mt-4">
                    <img
                      className="img-fluid flex-shrink-0 rounded-circle"
              ...
              <div className="col-lg-6">
                <div className="testimonial-item bg-transparent border rounded p-4 h-100">
                  <i className="fa fa-quote-left fa-2x text-primary mb-3"></i>
                  <p>Fourth testimonial here. Edit the content, name, and profession as needed.</p>
                  <div className="d-flex align-items-center mt-4">
                    <img
                      className="img-fluid flex-shrink-0 rounded-circle"
                    ...
                    />
                    <div className="ps-3">
                      <h5 className="mb-1">Emily Brown</h5>
